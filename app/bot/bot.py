...
from app.bot.middlewares.shadow_ban import ShadowBanMidddleware
...
async def main(config: Config) -> None:
    ...
    db_poll: psycopg_pool.AsyncConnectionPool = await get_pg_pool(
    ...
    # Подключаем мидлвари в нужном порядке
    logger.info("Including middlewares...")
    dp.update.middleware(DataBaseMiddleware())
    dp.update.middleware(ShadowBanMidddleware())
